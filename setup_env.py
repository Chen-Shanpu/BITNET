...
def gen_code():
    ...
    # Default kernel parameters for new Llama model scales (BM, BK, bm)
    NEW_MODEL_CODEGEN_TL1 = {
        "Llama-80M":  {"BM": "128,128,128", "BK": "64,64,64",    "bm": "64,64,64"},
        "Llama-120M": {"BM": "128,128,128", "BK": "128,64,64",   "bm": "64,64,64"},
        "Llama-300M": {"BM": "128,128,256", "BK": "128,64,64",   "bm": "64,64,32"},
        "Llama-500M": {"BM": "128,128,128", "BK": "128,64,64",   "bm": "64,64,64"},
        "Llama-700M": {"BM": "128,128,256", "BK": "128,64,64",   "bm": "64,64,32"},
        "Llama-1B":   {"BM": "128,128,256", "BK": "128,128,128", "bm": "64,64,32"},
    }
    NEW_MODEL_CODEGEN_TL2 = {
        "Llama-80M":  {"BM": "128,128,128", "BK": "96,96,96",  "bm": "32,32,32"},
        "Llama-120M": {"BM": "128,128,128", "BK": "96,96,96",  "bm": "32,32,32"},
        "Llama-300M": {"BM": "128,128,256", "BK": "96,96,96",  "bm": "32,32,32"},
        "Llama-500M": {"BM": "128,128,128", "BK": "96,96,96",  "bm": "32,32,32"},
        "Llama-700M": {"BM": "128,128,256", "BK": "96,96,96",  "bm": "32,32,32"},
        "Llama-1B":   {"BM": "128,128,256", "BK": "96,96,96",  "bm": "32,32,32"},
    }
    ...
    if arch == "arm64":
        ...
        if get_model_name() == "bitnet_b1_58-large":
            ...
            run_command([sys.executable, "utils/codegen_tl1.py", "--model", "bitnet_b1_58-3B", "--BM", "160,320,320", "--BK", "64,128,64", "--bm", "32,64,32"], log_step="codegen")
        elif get_model_name() in NEW_MODEL_CODEGEN_TL1:
            params = NEW_MODEL_CODEGEN_TL1[get_model_name()]
            run_command([sys.executable, "utils/codegen_tl1.py", "--model", get_model_name(),
                         "--BM", params["BM"], "--BK", params["BK"], "--bm", params["bm"]], log_step="codegen")
        else:
        ...
        if get_model_name() == "bitnet_b1_58-large":
            ...
            run_command([sys.executable, "utils/codegen_tl2.py", "--model", "bitnet_b1_58-3B", "--BM", "160,320,320", "--BK", "96,96,96", "--bm", "32,32,32"], log_step="codegen")
        elif get_model_name() in NEW_MODEL_CODEGEN_TL2:
            params = NEW_MODEL_CODEGEN_TL2[get_model_name()]
            run_command([sys.executable, "utils/codegen_tl2.py", "--model", get_model_name(),
                         "--BM", params["BM"], "--BK", params["BK"], "--bm", params["bm"]], log_step="codegen")
        else:
            raise NotImplementedError()
